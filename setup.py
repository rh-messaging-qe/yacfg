...
package_data = \
    {'': ['*'],
     'yacfg': ['profiles/_libs/*',
               ...
               'profiles/amq_broker/7.8.3/*',
               'profiles/amq_broker/7.8.3/_modules/bootstrap_xml/*',
               'profiles/amq_broker/7.8.3/_modules/broker_xml/store/*',
               'profiles/amq_broker/7.8.3/cluster/*',
               'profiles/amq_broker/7.8.3/ha/*',
               'profiles/amq_broker/7.8.3/performance/*',
               'profiles/amq_broker/7.8.3/security/gssapi/*',
               'profiles/amq_broker/7.8.3/security/gssapi_ldap/*',
               'profiles/amq_broker/7.8.3/store/jdbc/*',
