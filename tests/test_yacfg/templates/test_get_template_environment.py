...
from ..files.fakes import fake_templates_paths


@mock.patch("yacfg.templates.get_templates_paths", side_effect=fake_templates_paths)
...
def test_true(*_):
    ...
    expected_template_path = fake_templates_paths()[0]
...
@mock.patch("yacfg.files.get_templates_paths", side_effect=fake_templates_paths)
@mock.patch("yacfg.files.select_template_dir", side_effect=fake_select_template_dir)
